...
type ChartTooltipContentProps = {
  ...
  label?: any;
  labelFormatter?: (label: any, payload: ReadonlyArray<TooltipPayload<ValueType, NameType>>) => React.ReactNode;
    ...
    >
      ...
      <div className="grid gap-1.5">
        {payload.map((item, index) => {
          ...
          return (
            <div
              key={typeof item.dataKey === "string" || typeof item.dataKey === "number"
                ? item.dataKey
                : item.name ?? index}
              className={cn(
